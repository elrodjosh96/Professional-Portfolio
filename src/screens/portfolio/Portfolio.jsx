...
function Portfolio() {
  ...
  return (
    <div className="portfolio__main__container" id="portfolio">
      <h1>PORTFOLIO</h1>
      <p>Check out these repos and other projects I've worked on!
        <a href="https://github.com/elrodjosh96" target="_blank" rel="noreferrer"> https://github.com/elrodjosh96</a>
      </p>
